...
lumigo-cli/0.7.0 darwin-x64 node-v10.16.0
...
_See code: [src/commands/analyze-lambda-cost.js](https://github.com/lumigo-io/lumigo-cli/blob/v0.7.0/src/commands/analyze-lambda-cost.js)_
...
_See code: [src/commands/list-lambda.js](https://github.com/lumigo-io/lumigo-cli/blob/v0.7.0/src/commands/list-lambda.js)_
...
_See code: [src/commands/replay-sqs-dlq.js](https://github.com/lumigo-io/lumigo-cli/blob/v0.7.0/src/commands/replay-sqs-dlq.js)_
...
_See code: [src/commands/sls-remove.js](https://github.com/lumigo-io/lumigo-cli/blob/v0.7.0/src/commands/sls-remove.js)_
...
_See code: [src/commands/switch-profile.js](https://github.com/lumigo-io/lumigo-cli/blob/v0.7.0/src/commands/switch-profile.js)_
...
_See code: [src/commands/tail-dynamodb.js](https://github.com/lumigo-io/lumigo-cli/blob/v0.7.0/src/commands/tail-dynamodb.js)_
...
_See code: [src/commands/tail-kinesis.js](https://github.com/lumigo-io/lumigo-cli/blob/v0.7.0/src/commands/tail-kinesis.js)_
...
_See code: [src/commands/tail-sns.js](https://github.com/lumigo-io/lumigo-cli/blob/v0.7.0/src/commands/tail-sns.js)_
...
_See code: [src/commands/tail-sqs.js](https://github.com/lumigo-io/lumigo-cli/blob/v0.7.0/src/commands/tail-sqs.js)_
...
_See code: [src/commands/whoami.js](https://github.com/lumigo-io/lumigo-cli/blob/v0.7.0/src/commands/whoami.js)_
<!-- commandsstop -->
