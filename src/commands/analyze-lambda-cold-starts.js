...
AnalyzeLambdaColdStartsCommand.description = "Analyze Lambda functions cold starts in ALL regions";
...
const getStats = async (region, hours, functionNames) => {
	...
	console.log(`${region}: running CloudWatch Insights query against ${functionNames.length} log groups`);
